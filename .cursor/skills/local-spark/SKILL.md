...
name: local-spark
description: >-
  Runs local Spark SQL tests on Windows. Use when the user wants to test Spark SQL locally, verify local Spark environment, or run test_local_spark.py / test_local.sql.
---
